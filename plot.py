...
time_proj = [9.4374, 5.8514, 7.7032, 47.2000, 73.5998, 59.1062, 62.3231, 82.4156]
acc_proj = [0.9357, 0.8639, 0.8960, 0.7694, 0.9282, 0.7070, 0.7372, 0.6522]
base_proj = [5, 4, 4, 88, 119, 105, 114, 122]
